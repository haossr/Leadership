...
**********************************************************************
drop if countryn =="."
keep countryn country year cen elig_citizen elig_edu elig_inc elig_exp elig_end elig_ocu elig_age elig_reg elig_crm edu_ce edu_ceyear edu_cemajor firstterm_ce length_ce exp_ce_public exp_ce_publicyear exp_ce_vice exp_ce_viceyear exp_ce_minister exp_ce_ministeryear exp_ce_legis exp_ce_legisyear exp_ce_governor exp_ce_governoryear exp_ce_Ngovernor exp_ce_leglocalyear exp_ce_party exp_ce_partyyear exp_ce_central exp_ce_centralyear exp_ce_military exp_ce_militaryyear exp_ce_private exp_ce_privateyear exp_ce_manager exp_ce_manageryear ocu_ce_sector posttenurefate careerafter gender_ce birthyear_ce religion_ce elig_race Nterm_ce exp_ce_sector sourcefile sourcen source filename ismerge
sort countryn year
