...
graph save Graph ..\Graph\3_8_1.gph, replace
graph export ..\Graph\3_8_1.png, replace
twoway line edu_major_* year if democracy==0,t2title("Non-democratic")
graph save Graph ..\Graph\3_8_2.gph, replace
graph export ..\Graph\3_8_2.png, replace
graph combine ..\Graph\3_8_1.gph ..\Graph\3_8_2.gph, ycommon title("Education") subtitle("Trend of Education Level") 
graph export ..\Graph\3_8.png, replace
